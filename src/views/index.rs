...
use std::rc::Rc;
use actix_web::{get, App as ActixApp, Error, HttpResponse};
...
async fn fetch_user() -> UserResponse {
    ...
    let resp = reqwest::Client::new()
        .get("https://api.github.com/users/sascha1337")
...
pub async fn render_index() -> Result<HttpResponse, Error> {
    ...
    Ok(HttpResponse::Ok()
        ...
        .body(format!(
            r#"<!DOCTYPE HTML>
                <html>
                    <head>
                        <title>yew-ssr with actix-web</title>
                    </head>
                    <body>
                        <h1>yew-ssr with actix-web</h1>
                        {}
                    </body>
                </html>
            "#,
